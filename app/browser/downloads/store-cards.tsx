...
const stores = [
  {
    ...
    storeUrl: "https://play.google.com/store/apps/details?id=com.mira.app",
    icon: (
  ...
  },
  {
    ...
    storeUrl: "https://apps.apple.com/app/mira/id1234567890",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
...
export function StoreCards({ currentVersion }: StoreCardsProps) {
  return (
    <>
      {stores.map((store, idx) => (
        <article
          key={store.platform}
          className="download-card store-card animate-fade-up"
